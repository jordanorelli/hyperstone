...
func (EBaseClientMessages) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (EClientUIEvent) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*CClientMsg_CustomGameEvent) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*CClientMsg_ClientUIEvent) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func init() { proto.RegisterFile("clientmessages.proto", fileDescriptor1) }
