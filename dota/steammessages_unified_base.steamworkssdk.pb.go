...
func (EProtoExecutionSite) EnumDescriptor() ([]byte, []int) { return fileDescriptor37, []int{0} }
...
func init() { proto.RegisterFile("steammessages_unified_base.steamworkssdk.proto", fileDescriptor37) }
